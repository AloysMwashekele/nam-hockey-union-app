...
import { StyleSheet, View, FlatList, TouchableOpacity, SafeAreaView, StatusBar, Alert } from 'react-native';
      ...
      >
        <View style={styles.teamCardContent}>
          <View style={styles.teamHeader}>
            ...
            <Chip
              style={[styles.categoryChip, { backgroundColor: item.category === 'Men' ? Colors.primary : Colors.secondary }]}
              ...
              onPress={() => {
                Alert.alert(
                  ...
                  [
                    ...
                    { text: 'Delete', onPress: () => handleDeleteTeam(item.id), style: 'destructive' }
                  ]
                );
              }}
            >
...
const styles = StyleSheet.create({
  ...
  actionButton: { flexDirection: 'row', alignItems: 'center', paddingVertical: 6, paddingHorizontal: 12 },
  actionButtonText: { fontSize: 14, color: Colors.primary, marginLeft: 6 },
  loadingContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20 },
  loadingText: { marginTop: 16, color: Colors.textLight, fontSize: 14 },
  ...
  emptyText: { fontSize: 14, color: Colors.textLight, marginVertical: 8, textAlign: 'center', maxWidth: 280 },
